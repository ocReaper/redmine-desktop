(function () {
    ...
    function config($stateProvider, authenticatedOnly) {
      $stateProvider
        ...
        .state('issueManager', {
          url: '/issue-manager/:id',
          templateUrl: 'issues/views/issue-manager.tpl.html',
          controller: 'IssueManagerCtrl',
          controllerAs: 'issueManager',
          resolve: {
            issue: function (Issue, $stateParams, $q) {
              var id = $stateParams.id;
            ...
            issueStatuses: function (IssueStatus) {
              return IssueStatus
                .get()
                .$promise
                .then(function (response) {
